...
Use code media at full strength: structured SVG scenes with gradients, paths, filters, scene-to-video reuse, cinematic reference treatment, precise timing, and professional output review.
